  ...
  return (
    <div>
      ...
      <p>
          ...
          <div className="terms-and-definitions">
            <div>
                <strong>(i) Applications/App/Pikkro App:</strong> means the computer applications accessible from a Device and enabling access to Pikkro Services and shall include website <a href="https://www.pikkro.in/">https://www.pikkro.in/</a> mobile applications named Pikkro Same Day Courier Service for Android and iOS.
            </div>
            <div>
                <strong>(ii) Applicable Law:</strong> shall include all laws, statutes, ordinance, regulations, guidelines, policies, and other pronouncements having the effect of law of all or any applicable jurisdictions by state, municipality, court, tribunal, government, ministry, department, commission, arbitrator or board or such other body which has the force of law within the territory of India.
            </div>
            <div>
                <strong>(iii) Pikkro Services:</strong> mean Pikkro on-demand lead generation and related services that enable the Client to seek and receive on-demand requests for Courier Services from the Courier; such Pikkro Services include access to Pikkro’s App/Site and Pikkro’s software, payment services, and related support services systems, as may be updated or modified from time to time.
            </div>
            <div>
                <strong>(iv) Client:</strong> means an end Client, the adult individual, or the corporate entity represented by a duly authorized individual, authorized by Pikkro to use Pikkro Services for the purpose of obtaining Courier Services.
            </div>
            <div>
                <strong>(v) Content:</strong> shall include without limitation, data, text, written posts, comments, software, scripts, interactive features generated, graphics, images, photos, documents, audio, video, location, data, nearby places and all other forms of information or data.
            </div>
            <div>
                <strong>(vi) Courier:</strong> means the independent person registered in the Courier App, seeking for rendering the Courier Services.
            </div>
            <div>
                <strong>(vii) Courier App:</strong> means the mobile application provided by Pikkro that enables Courier to access Pikkro Services for the purpose of seeking, receiving, and fulfilling on-demand requests for Courier Services by the Client, as may be updated, or modified from time to time.
            </div>
            <div>
                <strong>(viii) Courier Services:</strong> means provision of courier delivery services to the Client via Pikkro Services in the Territory.
            </div>
            <div>
                <strong>(ix) Device:</strong> means the Client's or the Courier's Device, through which the Client or the Courier will access Pikkro Services; means a mobile device, computer/laptop owned or any other device owned or controlled by the Client or by the Courier: (a) that meets the specifications for mobile devices as set forth at <a href="https://www.pikkro.in/">https://www.pikkro.in/</a> and (b) on which the App has been installed as authorized by Pikkro for the purpose of obtaining Courier Services or providing the Courier Services that can allow the Client and to the Courier to have access to website of Pikkro i.e., <a href="https://www.pikkro.in/">https://www.pikkro.in/</a>.
            </div>
            <div>
                <strong>(x) Site:</strong> means <a href="https://www.pikkro.in/">https://www.pikkro.in/</a> providing access to Pikkro Services.
            </div>
            <div>
                <strong>(xi) Territory:</strong> means India in which the Client can request for delivery of goods.
            </div>
            <div>
                <strong>(xii) Third Party Privacy Policies:</strong> shall mean this Privacy Policy (as amended, modified or restated from time to time) read with the privacy policies of TSPs (as defined below).
            </div>
            <div>
                <strong>(xiii) TSPs:</strong> shall mean, third party service providers, as applicable, whose services are used in addition to or in conjunction with the Pikkro Services.
            </div>
            <div>
                <strong>(xiv) User Content:</strong> shall mean any Content that the User saves, submits, posts, displays, uploads, shares, transmits through the Pikkro Services, including but not limited to, images, photos, documents, and contact details saved therein by the User, profile information, and any other Content or information that User stores or makes available on the Site or App.
            </div>
            <div>
                <strong>(xv) User:</strong> means any person who accepts this Privacy Policy and Pikkro's Terms.
            </div>
        </div>
          1.Acceptance
